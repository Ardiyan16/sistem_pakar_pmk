...
<section id="services" class="services sections-bg">
    <div class="container" data-aos="fade-up">
        ...
        <div class="row mt-3">
            ...
            <table class="table table-success table-striped" id="data-penyakit">
                <thead>
                    <tr>
                        <th>No</th>
        ...
        <div class="row mt-3">
            ...
            <table class="table table-success table-striped" id="data-gejala">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Kode Gejala</th>
        ...
        <div class="row mt-3">
            <div class="section-header">
                <h2>Tabel Knowladge</h2>
            </div>
            <table class="table table-success table-striped" id="data-knowladge">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Gejala</th>
        ...
        <div class="row mt-3">
            <div class="section-header">
                <h2>Tabel Bobot Keyakinan</h2>
            </div>
            <table class="table table-success table-striped" id="data-bobot">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Keterangan</th>
...
<script>
     $(document).ready(function(){
        $('#data-penyakit').DataTable();
    });

    $(document).ready(function(){
        $('#data-gejala').DataTable();
    });

    $(document).ready(function(){
        $('#data-knowladge').DataTable();
    });
